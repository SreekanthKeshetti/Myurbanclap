...
const Bookings = () => {
  ...
  const getStatusColor = (status) => {
    ...
    return "primary"; // InstaClean Teal via Bootstrap mapping
  };
        ...
        <Container fluid="xl" className="px-lg-5">
                        ...
                        <div className="p-3 bg-light border-top mt-auto d-flex flex-wrap gap-2 justify-content-end align-items-center">
                          ...
                          {[
                            ...
                            <Button
                              ...
                              size="sm"
                              className="rounded-pill fw-bold px-4 bg-white"
                          ...
                          {booking.status === "ontheway" && (
                            <Button
                              variant="dark"
                              size="sm"
                              className="rounded-pill fw-bold px-4 btn-primary-custom"
                          ...
                          {/* Pre-job Actions (Cancel/Reschedule) */}
                          ...
                          {/* Post-Job Actions (Review) */}
                          {booking.status === "completed" &&
                            !booking.isReviewed && (
                              <Button
                                variant="dark"
                                size="sm"
                                className="rounded-pill fw-bold px-4 btn-primary-custom w-100 w-sm-auto"
          ...
          >
            ...
            <Modal.Footer className="border-0 pt-0 d-flex flex-nowrap">
              <Button
                variant="light"
                className="rounded-pill fw-bold w-50 py-2"
          ...
          >
            ...
            <Modal.Footer className="border-0 pt-0 d-flex flex-nowrap">
              ...
              <Button
                variant="dark"
                className="rounded-pill fw-bold w-50 py-2 btn-primary-custom"
